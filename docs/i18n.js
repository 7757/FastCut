...
(function () {
  const I18N = {
    en: {
      ...
      dl_req: "macOS 14+ · Apple Silicon", copy: "Copy", copied: "Copied", dl_or: "or",
    ...
    zh: {
      ...
      dl_req: "macOS 14 或更高 · Apple Silicon", copy: "复制", copied: "已复制", dl_or: "或",
    ...
    ja: {
      ...
      dl_req: "macOS 14 以降 · Apple Silicon", copy: "コピー", copied: "コピー済み", dl_or: "または",
    ...
    ko: {
      ...
      dl_req: "macOS 14 이상 · Apple Silicon", copy: "복사", copied: "복사됨", dl_or: "또는",
